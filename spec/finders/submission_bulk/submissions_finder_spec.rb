  ...
  describe 'methods' do
    ...
    describe '#find_submissions_for_subjects' do
      ...
      context 'with group exercise' do
        ...
        let(:submission_3) { FactoryGirl.create(:submission, exercise: other_exercise, student_group: student_group_3) }
      ...
      context 'with solitary exercise' do
        ...
        let(:submission_3) { FactoryGirl.create(:submission, exercise: other_exercise) }
        let!(:submissions) { [submission_1, submission_2, submission_3]}
        ...
        let(:exercise_registration_2) { FactoryGirl.create(:exercise_registration, exercise: exercise, term_registration: student_term_registration_2, submission: submission_2)}
        let(:exercise_registration_3) { FactoryGirl.create(:exercise_registration, exercise: exercise, term_registration: student_term_registration_2, submission: submission_3)}
        let(:exercise_registration_4) { FactoryGirl.create(:exercise_registration, exercise: exercise, term_registration: student_term_registration_3, submission: submission_3)}

        let!(:exercise_registrations) { [exercise_registration_1, exercise_registration_2] }
        let!(:other_exercise_registrations) { [exercise_registration_3, exercise_registration_4] }
