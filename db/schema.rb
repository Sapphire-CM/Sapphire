...
ActiveRecord::Schema.define(:version => 20130211140604) do
  ...
  add_index "accounts", ["accountable_id", "accountable_type"], :name => "index_accounts_on_accountable_id_and_accountable_type", :unique => true
