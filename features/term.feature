Feature: Term
  ...
  Scenario: Create a term
    Given there is a course called "My Course"
    Given I am logged in
    And I am on the home page
    When I create a new term called "My New Term" on course "My Course"
    Then I should see term entry "My New Term" on course "My Course"

  @javascript
  Scenario: Update a term
    Given there is a course "My Course" with a term "Strange Term"
    Given I am logged in
    And I am on the home page
