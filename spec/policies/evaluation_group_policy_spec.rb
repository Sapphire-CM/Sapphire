...
RSpec.describe EvaluationGroupPolicy do
  ...
  context 'as admin' do
    ...
    let(:evaluation_group) { FactoryGirl.create(:evaluation_group) }
  ...
  %I(lecturer tutor).each do |role|
    context "as #{role}" do
      ...
      context 'of term' do
        ...
        let(:evaluation_group) { FactoryGirl.create(:evaluation_group, submission_evaluation: submission_evaluation) }
