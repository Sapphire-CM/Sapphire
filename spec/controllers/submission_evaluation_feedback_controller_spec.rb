...
RSpec.describe SubmissionEvaluations::FeedbackController, type: :controller do
  render_views
  ...
  it_behaves_like 'a comment' do
    ...
    let(:comment) { FactoryGirl.create :feedback_comment, account: current_account, commentable: commentable }
  end
end
