...
RSpec.describe SubmissionUploadPolicy do
  let(:submission_upload) { SubmissionUpload.new(submission: submission) }
  subject { described_class.new(account, submission_upload) }
