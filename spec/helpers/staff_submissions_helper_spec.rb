...
describe StaffSubmissionsHelper do
  describe "staff_submission_title" do
    it "should generate the appropriate title for a submission with a student group" do
      ...
      subject.staff_submission_title(submission).should eq("Submission of Group 01")
    end
    ...
    it "should generate the appropriate title for a submission without a student group" do
      ...
      subject.staff_submission_title(solitary_submission).should eq("Submission of unknown student")
      subject.staff_submission_title(group_submission).should eq("Submission of unknown group")
    end
  end
end
