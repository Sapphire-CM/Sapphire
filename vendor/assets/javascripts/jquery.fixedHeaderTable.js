  ...
  $.fn.fixedHeaderTable = function (method) {
    ...
    var methods = {
      ...
      setup: function () {
        ...
        var tbodyHeight = $wrapper.height() - $thead.outerHeight(true) - tfootHeight - tableProps.border - 40;
    ...
    var helpers = {
       ...
       * return void
       */
      _fixHeightWithCss: function ($objs, tableProps) {
        $.each($objs, function(){
          var $obj = $(this);
      ...
      _setupFixedColumn: function ($obj, obj, tableProps) {
        ...
        // Fix cell heights
        helpers._fixHeightWithCss($firstThChildren, tableProps, 2);
        ...
        // clone header
        var thead_thead = $thead.appendTo($fixedColumn).find('thead');
        var tr;
        $firstThChildren.each(function(index){
          if (index % settings.fixedColumns == 0) {
            tr = $("<tr/>").appendTo(thead_thead);
          }
        ...
        $firstTdChildren.each(function(index) {
          if (index % settings.fixedColumns == 0) {
            $newRow = $('<tr></tr>').appendTo($tbody.find('tbody')).addClass($(this).closest("tr").attr("class"));
